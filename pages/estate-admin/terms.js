                            ...
                            <div className="col-xl-12 col-lg-12">
                                ...
                                <div className="definitions-section" style={{ marginTop: '30px', padding: '20px', backgroundColor: '#fff', borderRadius: '8px', boxShadow: '0 2px 8px rgba(0,0,0,0.05)' }}>
                                    ...
                                    <dl style={{ margin: 0 }}>
                                        ...
                                        <dd style={{ marginLeft: '0', paddingLeft: '15px', borderLeft: '3px solid #eee', marginBottom: '15px', color: '#555' }}>A Testator is generally someone who makes a Will. The term Testatrix is used to specifically refer to a woman who makes a Will. When a person dies leaving a Will, he is said to have died Testate.</dd>
                                        
                                        <dt style={{ fontWeight: 'bold', marginTop: '15px', color: '#333' }}>Executor</dt>
                                        <dd style={{ marginLeft: '0', paddingLeft: '15px', borderLeft: '3px solid #eee', marginBottom: '15px', color: '#555' }}>An Executor is someone who is named or appointed in a Will to deal with or administer the estate of a deceased person.</dd>

                                        <dt style={{ fontWeight: 'bold', marginTop: '15px', color: '#333' }}>Administrator</dt>
                                        <dd style={{ marginLeft: '0', paddingLeft: '15px', borderLeft: '3px solid #eee', marginBottom: '15px', color: '#555' }}>An Administrator is someone who is appointed to deal with or administer the estate of a deceased person where he dies intestate (without a valid Will), or where he dies leaving a valid Will but appoints no executor, or the appointed executor is unable or unwilling to act.</dd>

                                        <dt style={{ fontWeight: 'bold', marginTop: '15px', color: '#333' }}>Beneficiary</dt>
                                        <dd style={{ marginLeft: '0', paddingLeft: '15px', borderLeft: '3px solid #eee', marginBottom: '15px', color: '#555' }}>A Beneficiary is someone who is to receive a gift or property under a Will.</dd>

                                        <dt style={{ fontWeight: 'bold', marginTop: '15px', color: '#333' }}>Heir</dt>
                                        <dd style={{ marginLeft: '0', paddingLeft: '15px', borderLeft: '3px solid #eee', marginBottom: '15px', color: '#555' }}>An Heir is a person who is entitled to receive property from a person who dies intestate (without a Will).</dd>
                                    </dl>
                                </div>
                                ...
                                <div className="process-section" style={{ marginTop: '30px', padding: '20px', backgroundColor: '#fff', borderRadius: '8px', boxShadow: '0 2px 8px rgba(0,0,0,0.05)' }}>
                                    <h3 style={{ borderBottom: '2px solid #28a745', paddingBottom: '10px', color: '#28a745', marginBottom: '20px' }}>The Estate Administration Process</h3>
                                    <p>The estate administration process involves a series of actions that must be taken by an administrator or executor/executrix in order to successfully complete the distribution of assets. We can outline four broad categories:</p>
                                ...
                                <div className="note-section" style={{ marginTop: '30px', padding: '15px', borderLeft: '5px solid #ffc107', backgroundColor: '#fff3cd', borderRadius: '5px' }}>
                                    ...
                                    <p style={{ margin: 0, color: '#856404' }}>
                                        In Guyana, small estates (involving movable assets valued at less than $750,000 as at the date of death) can be distributed without having to apply to the High Court pursuant to Section 25(1) B of the Deceased Persons Estates Administration Act, Chapter 12:01, as amended by the{' '}
