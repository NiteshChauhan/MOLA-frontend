                            ...
                            <div className="col-xl-12 col-lg-12">
                                ...
                                <div className="section-block" style={{ marginBottom: '40px', padding: '20px', backgroundColor: '#fff', borderRadius: '8px', borderLeft: '5px solid #007bff', boxShadow: '0 2px 8px rgba(0,0,0,0.05)' }}>
                                    ...
                                    <p style={{ color: '#555', marginBottom: '15px' }}>
                                        In order to commence the estate administration process, you will be required to provide a list of documents mentioned in the Estate Requirement Sheet (<a href="#" style={{ color: '#dc3545', textDecoration: 'underline' }}>insert link to sheet here</a>). 
                                    </p>
                                ...
                                <div className="section-block" style={{ marginBottom: '40px', padding: '20px', backgroundColor: '#fff', borderRadius: '8px', boxShadow: '0 2px 8px rgba(0,0,0,0.05)' }}>
                                    <h3 style={{ borderBottom: '2px solid #28a745', paddingBottom: '10px', color: '#28a745', marginBottom: '15px' }}>Fees and Charges</h3>
                                    ...
                                    <ul style={{ listStyleType: 'none', paddingLeft: '0', color: '#555', borderBottom: '1px dashed #ddd', paddingBottom: '10px', marginBottom: '15px' }}>
                                        <li style={{ marginBottom: '5px' }}>Admin Fee to Begin: $4000 (four thousand dollars)</li>
                                        <li style={{ marginBottom: '5px' }}>Commission: 8% of the first $10,000.00 and 5% of the remainder of all money received or realized for the estate.</li>
                                    </ul>
                                    ...
                                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '10px', maxWidth: '400px', backgroundColor: '#f9f9f9', padding: '10px', borderRadius: '5px' }}>
                                        ...
                                        <span style={{ gridColumn: 'span 2' }}>$5,000.00</span>
                                        
                                        <span>GBTI</span>
                                        <span style={{ gridColumn: 'span 2' }}>$3,000.00</span>
                                    ...
                                    <ul style={{ listStyleType: 'none', paddingLeft: '0', color: '#555' }}>
                                        ...
                                        <ul style={{ listStyleType: 'circle', paddingLeft: '20px' }}>
                                            <li style={{ marginBottom: '5px' }}>Letters of Administration fee - $3,500.00</li>
                                            <li style={{ marginBottom: '5px' }}>Probate or Letters of Administration with will annexed - $4,500.00</li>
                                        </ul>
                                    </ul>
                                </div>
