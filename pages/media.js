                                        ...
                                        <div className="col-lg-4 col-md-6 col-sm-12 col-xs-12 grid_box">
                                            <div className="news_box style_one blog_classic has_images">
                                                <div className="image img_hover-1">
                                                    <img width={750} height={420} src="/assets/images/blog/default.jpg" className="wp-post-image" alt="img" />
                                                ...
                                                <div className="content_box">
                                                    ...
                                                    <Link href="#" className="categories"><i className="icon-folder" />Lorem ipsum dolor</Link>
                                                    <h2 className="title"><Link href="/" >Donec magna purus, facilisis vel porttitor at</Link></h2>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="col-lg-4 col-md-6 col-sm-12 col-xs-12 grid_box">
